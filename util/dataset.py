...
from util.utils import pad_seq, bytes_to_file, read_split_image, shift_and_resize_image, normalize_image
            ...
            while True:
                try:
                    ...
                    if len(examples) % 1000 == 0:
                        print("processed %d example" % len(examples))
                except EOFError:
                    break
                except Exception:
                    pass
...
def process(img, augment):
    ...
    try:
        ...
        if augment:
            ...
            # NOTE: image A and B need to be in sync as how much
            # to be shifted
            w, h = img_A.shape
